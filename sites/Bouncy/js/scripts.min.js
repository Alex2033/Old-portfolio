...
$(document).ready(function () {
	...
	$(document).on('click', '.nav-list__link, .down-anchor', function(event){
	...
	$(".team-carousel, .testis, .blogs").slick({
		slidesToShow: 1,
		slidesToScroll: 1,
		dots: true,
		arrows: false
	...
	$(".map__icon").click(function() {
		$(".map__overlay").css({"height": "0", "opacity": "0"});
	});
...
function initMap() {
	...
	var map = new google.maps.Map(document.getElementById('map__geo'), {
		zoom: 17,
		center: uluru
	});
